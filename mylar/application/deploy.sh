...
export app_url="https://github.com/evilhero/mylar"
export app_git_url="https://github.com/evilhero/mylar.git"
export app_destdir="/opt/mylar"

#export app_cmd="/usr/bin/python /opt/headphones/Headphones.py"
export app_svname="mylar"
export app_psname="Mylar.py"
